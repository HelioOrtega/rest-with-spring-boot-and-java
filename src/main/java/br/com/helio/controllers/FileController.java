...
import br.com.helio.services.FileStorageService;
...
import br.com.helio.data.vo.v1.UploadFileResponseVO;
...
@Tag(name = "File Endpoint", description = "Uploads or downloads files")
